...
export interface paths {
    ...
    "/api/auth/verify-email/{token}": {
        ...
        /** Verify Email */
        get: operations["verify_email_api_auth_verify_email__token__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/organizations/{org_id}/repositories/{repo_id}/findings/{finding_id}/explain": {
        ...
        put?: never;
        /** Explain Finding */
        post: operations["explain_finding_api_organizations__org_id__repositories__repo_id__findings__finding_id__explain_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/organizations/{org_id}/repositories/{repo_id}/finding-explanations/{explanation_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["get_finding_explanation_api_organizations__org_id__repositories__repo_id__finding_explanations__explanation_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/organizations/{org_id}/pr-reviews": {
        ...
        /** List Pr Reviews */
        get: operations["list_pr_reviews_api_organizations__org_id__pr_reviews_get"];
        put?: never;
        /** Review Pull Request */
    ...
    "/api/organizations/{org_id}/billing/checkout": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["create_checkout_session_api_organizations__org_id__billing_checkout_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/organizations/{org_id}/billing/portal": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["create_portal_session_api_organizations__org_id__billing_portal_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        BillingResponse: {
            ...
            /** Usage */
            usage: {
                [key: string]: components["schemas"]["UsageDimension"];
            };
        };
        /** CheckoutResponse */
        CheckoutResponse: {
...
export interface operations {
    ...
    verify_email_api_auth_verify_email__token__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    explain_finding_api_organizations__org_id__repositories__repo_id__findings__finding_id__explain_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["FindingExplanationResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_finding_explanation_api_organizations__org_id__repositories__repo_id__finding_explanations__explanation_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_pr_reviews_api_organizations__org_id__pr_reviews_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    create_checkout_session_api_organizations__org_id__billing_checkout_post: {
        parameters: {
            query: {
                plan: string;
            };
    ...
    create_portal_session_api_organizations__org_id__billing_portal_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
